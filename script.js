...
const months = [31, 28, 31, 30, 31, 31, 31, 30, 31, 30, 31];

//function to validate day,month and year taken from the input
function validate() {
...
//submit function to calculate age and show as output
...
//adding the eventlistener to form
